<script>
	const opiniones = [
		{
			comentario: "Muy profesionales y atentos, un buen lugar para la atención dental que es muy importante. Además que el equipamiento es el mejor!",
		...
		{
			comentario: "Una clínica con grandes profesionales, y sobretodo con muy buena atención y amabilidad. Mis dientes derechitos en poco tiempo",
			autor: "Ana Belén Cuba"
		}
	]
...
<div class="arrows">
	<button type="button" on:click={nextOpinion}>
...
<style>
	...
	.arrows button:active path{
		fill: var(--teal);
	}
	.arrows button:first-child:hover {
