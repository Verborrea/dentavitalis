<script>
	import src from '$lib/images/servicios/servicios.webp'
...
<section>
	<div class="text-container">
		...
		<Button
			...
			target="_blank"
			--bkg="#009bb3" --color="var(--white)" --h_bkg="var(--blue)" --h_color="var(--white)"
